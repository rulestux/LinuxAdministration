...
- __ssh-copy-id__ para enviar a chave pública para o arquivo '~/.ssh/authorized_keys' de um host remoto: 

	- ```$ ssh-copy-id -i ~/.ssh/PUBLIC_KEY_FILE.pub USERNAME@IP_HOST ```.
